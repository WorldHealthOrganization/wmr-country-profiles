          ...
          <div className="p-6 print:p-3">
            ...
            <div className="space-y-4 print:space-y-2">
              <div className="bg-red-50 rounded-lg p-4 print:p-2 avoid-break">
                <h4 className="font-medium text-gray-900 mb-2 print:text-xs print:mb-1">Major Plasmodium Species</h4>
                    ...
                    {data.resistanceStatus
                      ...
                      .map((resistance, index) => (
                        <tr key={index} className="avoid-break">
                          ...
                          <td className="py-2 px-2 text-center print:py-1 print:px-1">{resistance.sites !== null ? resistance.sites : '-'}</td>
                          <td className="py-2 px-2 text-center italic print:py-1 print:px-1">{resistance.vectors}</td>
                          <td className="py-2 px-2 text-center print:py-1 print:px-1">{resistance.used !== null ? (resistance.used ? 'Yes' : 'No') : '-'}</td>
                        </tr>
                      ))}
                  </tbody>
                </table>

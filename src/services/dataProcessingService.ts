...
class DataProcessingService {
  ...
  async processCountryData(orgUnit: string, period: string): Promise<CountryProfileData> {
    ...
    const policyYesNoElements = [
      ...
      'JKP3ANVLyjN', 'H9P0BVxKBYM', 'VBkox9y1nbh', 'geSDyXkZNU1', 'J0l8s0YfOgb',
      'XspXjIPulp1', 'mnXwuC5mGvY', 'QPya9cXIb53', 'lLdqBPGWhu1', 'DyINPGgopL3',
    ...
    const policyYearElements = [
      ...
      'tbntOU0xvJo', 'VDihj2VLq4A', 'htRtowcXu3u', 'n1L03jjC8ej', 'JjvoR3Zla9A', 
      'tzQSkn745VU', 'RJ8gDWeegYJ', 'J6hSXbYHhkp', 'NJZIDMAfHWt', 'UKsKOT9K9SQ', 
    ...
    try {
      ...
      const policyData: PolicyDefinition[] = [
        ...
        { intervention: 'Treatment', strategy: 'Single dose of primaquine is used as gametocidal medicine for P. falciparum', policyUID: 'KmPLPFZJpHU', yearUID: 'SEzJzC07clE', validUntilYear: 2023, displayOrder: 12 },
